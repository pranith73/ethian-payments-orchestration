...
public final class Customer {
    ...
    private Customer(String customerId, String emailOrPhone, String name, String billingAddress, String metadata) {
    ...
    public static Customer of(String customerId, String emailOrPhone, String name, String billingAddress, String metadata) {
